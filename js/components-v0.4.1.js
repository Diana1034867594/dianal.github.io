(function(){
 ...
 <a class="site-title" href="${h('index.html')}">Xinyu Liao</a>
 ...
 <a class="${current==='about'?'active':''}" href="${h('about.html')}">About</a>
 <div class="nav-item"><a class="${current==='projects'||current==='posts'?'active':''}" href="${h('projects.html')}">Projects</a><button class="submenu-toggle" type="button" aria-expanded="false" aria-label="Open project categories">⌄</button><div class="submenu">
 ...
 <a class="${current==='contact'?'active':''}" href="${h('contact.html')}">Contact</a>
 </nav></div></header>`;
 const footer=`<footer class="site-footer"><div class="page-shell footer-grid"><div><h2>Xinyu Liao</h2><p class="footer-intro">Localization professional working across language, technology, content quality, and multilingual user experiences.</p></div><div class="footer-contact"><h3>Let’s connect</h3><a href="mailto:d1034867594@gmail.com">d1034867594@gmail.com</a><a href="https://www.linkedin.com/in/xinyu-liao" target="_blank" rel="noopener noreferrer">linkedin.com/in/xinyu-liao</a></div></div></footer>`;
